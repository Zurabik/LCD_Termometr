...
// Библиотека использует програмный SPI

// Распиновка порта
#define LCD_DC_PIN                 D, 7
#define LCD_CE_PIN                 B, 0
#define LCD_RST_PIN                B, 1
#define LCD_SDIN_PIN               D, 6 
...
typedef enum
{
	...
	FONT_BIG_I = 3    // Большой размер шрифта для цифр 14х24
...
// 
// static const byte BigFontLookup [][42] PROGMEM =
// {
// 
